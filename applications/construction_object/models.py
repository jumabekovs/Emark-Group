...
class Room(models.Model):
    ...
    terrasse = models.DecimalField(max_digits=4, decimal_places=2, verbose_name='терраса', blank=True, null=True)
    ...
    wc_2 = models.DecimalField(max_digits=4, decimal_places=2, verbose_name='санузел 2', blank=True, null=True)
